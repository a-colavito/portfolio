  ...
  return (
    <section>
      ...
      <p className="mb-4">
        ...
        potrai leggerle nel <a href="https://res.cloudinary.com/dkkvkj82k/image/upload/v1749566768/CV_it_dby0co.pdf" target="_blank" rel="noopener noreferrer" className="underline">curriculum</a>, quindi saltiamo alla parte meno noiosa ecco una lista di cose che mi piacciono:
      </p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 max-w-lg">
        ...
        {status === 'success' && (
          <div className="p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
            <p className="text-green-800 dark:text-green-200 text-sm">✓ Messaggio inviato con successo! Ti risponderò presto.</p>
          </div>
        )}

        {status === 'error' && (
          <div className="p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
            <p className="text-red-800 dark:text-red-200 text-sm">✗ Errore nell'invio del messaggio. Riprova.</p>
          </div>
        )}
      </form>
